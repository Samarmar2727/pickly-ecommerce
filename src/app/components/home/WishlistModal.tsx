    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50">
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-[#C0D6E4] p-6 rounded-lg shadow-lg max-w-lg w-full relative">
          ...
          <h2 className="text-2xl font-bold mb-4 text-[#A47864]">Your Wishlist</h2>
          ...
          {isWishlistLoading ? (
            ...
            <ul>
              {wishlist.products.map((product) => (
                <li key={product._id} className="flex items-center justify-between py-2 border-b border-[#A47864]">
